...
class KAOTH(nn.Module):

    def __init__(self,
                 outputDim=128,
                 clipPath="/home/iot/space5/shard_pool_data5/KAOTH-main/RN50.pt",
                 writer=None,
                 saveDir="./result/log",
                 logger: logging.Logger = None,
                 is_train=True):
        super(KAOTH, self).__init__()
    ...
    def encode_image(self, image):
        ...
        return self.imagekan(image_embed)  
    
    def encode_text(self, text):
        text_embed = self.clip.encode_text(text)
        return self.textkan(text_embed)  
    ...
    def visualize_manifolds(self, image_data, text_data,epoch,index, method='tsne'):
        ...
        plt.savefig("/home/iot/space5/shard_pool_data5/KAOTH-main/swissroll/{}".format(epoch)+"_"+"{}".format(timestamp)+".png")
        plt.close()
