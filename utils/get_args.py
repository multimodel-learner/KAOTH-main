...
def get_args():
    ...
    parser.add_argument("--hash-layer", type=str, default="linear",
                        help="choice a hash layer [select, linear] to run. select: select mechaism, linear: sign function.")
    parser.add_argument("--save-dir", type=str, default="./result/64-bit")
    parser.add_argument("--clip-path", type=str,
                        default="./ViT-B-32.pt", help="pretrained clip path.")
    parser.add_argument("--pretrained", type=str, default="")
    parser.add_argument("--dataset", type=str, default="flickr25k",
                        help="choise from [coco, mirflckr25k, nuswide]")
    ...
    parser.add_argument("--lr-decay-freq", type=int, default=6)  # 8
    parser.add_argument("--display-step", type=int, default=50)
    parser.add_argument("--seed", type=int, default=42)  # 1814 42
    ...
    parser.add_argument("--count", type=float, default=5)
    parser.add_argument("--reg", type=float, default=1)
    parser.add_argument("--batch_norm", type=int, default=3)
